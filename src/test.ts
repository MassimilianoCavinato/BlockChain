...
async function runTest(){
    //INSTANCE NODES
    const node_relay = new NetworkNode(3040);
    await delay(2000);
    const node_3041 = new NetworkNode(3041);
    await delay(2000);
    const node_3042 = new NetworkNode(3042);
    await delay(2000);
    const node_3043 = new NetworkNode(3043);
    await delay(2000);
    const node_3044 = new NetworkNode(3044);
    await delay(2000);
    const node_3045 = new NetworkNode(3045);
